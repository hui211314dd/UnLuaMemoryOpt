...
namespace UnLua
{
    ...
    protected:
        ...
        static bool GetMemInfo(lua_State*L, size_t size, LuaMemInfo&info);
        
        static MemoryDetail* TryGetMemoryRecord(lua_State* L);

        static void AddRecord(lua_State*L, void* ptr, size_t size, LuaMemInfo& memInfo);

        static void RemoveRecord(lua_State*L, void*ptr, size_t osize);
